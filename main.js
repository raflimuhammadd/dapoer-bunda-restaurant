...
const showMenu = (toggleId, navId) => {
    ...
    if (toggle && nav) {
        //ADD SHOW-MENU CLASS TO DIV TAG WITH nav__menu class
...
themeButton.addEventListener('click', () => {
    // ADD 0R REMOVE DARK ICON 
    document.body.classList.toggle(darkTheme)
    themeButton.classList.toggle(iconTheme)
    // we save the theme and the current icon that the user chose before 
